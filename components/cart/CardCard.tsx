      ...
      <div className="flex">
        <div className="bg-customGray overflow-hidden content-center rounded-lg">
          <img
            ...
            src="https://res.cloudinary.com/hilnmyskv/image/upload/v1638371385/flagship_sunrise/M0E20000000DTSX_1.jpg"
            width={100}
            height={50}
          />
        </div>
        <div className="ml-4">
          <h1 className="font-bold">Gradient Graphict T-shirt</h1>
          <div className="flex">
            <h3>Size: </h3>
            <h3 className="ml-3 font-thin">Large</h3>
          </div>
          <div className="flex">
            <h3>Color: </h3>
            <h3 className="ml-3 font-thin">White</h3>
          </div>
          <div className="text-2xl font-bold mt-5">$ 145</div>
        </div>
      </div>
